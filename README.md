...
A Node.js command-line application that takes in information about employees on a software engineering team, then generates an HTML webpage that displays summaries for each person. Testing is key to making code maintainable, so this project includes unit tests for every part of the code and ensures that it passes each test.
...
You can find a video demonstration of this application using the following link. 

https://drive.google.com/file/d/1srIORIrq7-kw19VuQCFI7lH6XqZlwO89/view?usp=sharing
